...
#         self._init_weights(mean=0.0, std=0.03)
    ...
    def forward(self, x, previous_level_projection=None, label_level=0):
        ...
        if self.attention_mode == "caml":
            ...
            weights            = self.gcn_1_layer[label_level](self.gcn_1_data[label_level]).t()
        ...
        att_weights            = self.gcn_2_layer[label_level](self.gcn_2_data[label_level])
        ...
        gcn_weighted_output    = self.gcn_3_layer[label_level](self.gcn_3_data[label_level])
